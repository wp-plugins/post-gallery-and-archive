...
Description: Creates a nice post gallery/post archive, uses a choosen category to show a grid list of posts with image, read more and the excerpt. implemented easily via shortcode.
Version: 0.3
